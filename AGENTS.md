...
- Keep notes in Markdown and preserve existing links and structure.
- Prefer small, focused edits. Do not delete or reorganize notes unless explicitly asked.
- Put new unsorted notes in `00 Inbox/`.
...
- For personal finance transactions, follow `.agents/skills/finance-hledger/SKILL.md`.
- For side projects, follow `.agents/skills/project-management/SKILL.md`.
